  ...
  return (
    <div className='start-wrapper'>
      ...
      <div className='start'>
        ...
        {confirmtext && <div class="mission-confirm-text">Are you sure you wish to begin salvage mission?</div>}
        {confirmbutton && <Link to="/Mission" className='mission-confirm-btn1'>Yes</Link>}
        {confirmbutton && <div className='mission-confirm-btn2' onClick={denyMission}>Go Back</div>}
        {missionbuttons && <div className='mission-btn' onClick={confirmMission}>Begin Mission</div>}
        <div className='intro-choices'>
          {missionbuttons && <Link to="/Ship" className='intro-btn'>Go to Ship</Link>}
          {missionbuttons && <Link to="/Station" className='intro-btn'>Go to Station</Link>}
        </div>
